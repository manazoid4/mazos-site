...
export const FLAGSHIP_PROJECTS: Project[] = [
  {
    ...
    image: { src: '/jobfilter-scan-result.webp', mobileSrc: '/jobfilter-scan-result-mobile.webp', alt: 'JobFilter showing an honest zero-result scan after checking configured public tender sources', caption: 'Live scan result / verified matching can return zero' },
    links: [
...
export const FEATURED_PROJECTS: Project[] = [
  {
    ...
    image: { src: '/agent-nudge-demo.webp', alt: 'Agent Nudge demo showing two coding agents and a conflict review outcome', caption: 'Public fixture demo / desktop runtime remains local' },
